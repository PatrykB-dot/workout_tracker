<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <!-- Register -->
    <form @submit.prevent="register" class="p-4 flex flex-col bg-light-grey rounded-md shadow-lg">
      ...
      hover:border-at-light-green hover:bg-white hover:text-at-light-green">Register</button>
